...
- [x] **Phase 28: Voice Script, TTS, and Lip Sync Layer** - Structured voice scripts bound to Production Bible cast voices, ElevenLabs line generation, voice mixing, and optional post-video lip-sync (completed 2026-06-08)
...
| 28. Voice Script, TTS, and Lip Sync | 2/2 | Complete    | 2026-06-08 |
...
- [x] 28-01-PLAN.md — VoiceScript/VoiceLine foundation, binding resolution, ElevenLabs line generation, and Screenplay Voice tab
- [x] 28-02-PLAN.md — Voice mixing artifacts, ffmpeg overlay path, lip-sync job model, adapter boundary, and UI status integration
