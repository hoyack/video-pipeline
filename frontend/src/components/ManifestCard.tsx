...
export function ManifestCard({
  ...
  return (
    <div
      onClick={() => onView(manifest.manifest_id)}
      className="cursor-pointer rounded-lg border border-gray-800 bg-gray-900/50 p-4 transition-colors hover:border-gray-700"
    >
